...
from isotopic_logging.context import injection_context
...
class ContextTestCase(unittest.TestCase):
    ...
    def test_injection_context_parallel(self):
        ...
        with injection_context(injector1) as inj:
            self.assertEqual(inj, injector1)

        with injection_context(injector2) as inj:
    ...
    def test_injection_context_nested(self):
        ...
        with injection_context(injector1) as top_inj:
